    ...
    <div class="masthead">
        <div class="masthead-content text-white">
            <div class="container-fluid px-4 px-lg-0">
                ...
                <!-- to get an API token!-->
                <form id="contactForm" method="post" action="{{url("news")}}">
                    <!-- Email address input-->
                    <div class="row input-group-newsletter">
                        <div class="col">
                            <!-- display success message that come from controller -->
                            @if(Session::has('success'))
                            <div class="alert alert-success" role="alert">
                                {{Session::get('success')}}
                            </div>
                            @endif
                            <!-- display error message that come from controller -->
                            @if(Session::has('fail'))
                            ...
                            <input class="form-control" id="email" type="email" placeholder="Enter email address..."
                                aria-label="Enter email address..." data-sb-validations="required,email" name="email" />
                                @error('email')
